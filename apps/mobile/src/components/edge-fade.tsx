 ...
 * paints. Purely decorative: it never takes a touch and never reaches assistive
 * technology. The colour is `background` from the ambient theme, so it follows
 * the ВИГЛЯД choice and goes dark inside the Ворожка reveal for free.
 */
