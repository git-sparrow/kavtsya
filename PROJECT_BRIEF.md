...
6. **UI redesign** (Mari handoff, epic #131). Full spec + 79 screens vendored at `docs/design/handoff/`; map at `docs/design/redesign-reconciliation.md`. Sliced per turn: tokens #132 → home/redemption/Ворожка #133 → owner scan #134 → owner home/config #135 → settings/analytics #136 → role subscreens #137 → confirm dialogs #138 → client export #139 → deletion-exit/transfer screens #143 (coupled to #81, which stays archival-only — ADR-0014 conflict recorded in #143). Not started.
