...
_Last updated: 2026-07-18 · Status: **building** — scope and architecture locked. **This line + the Roadmap below are the single status home** (CLAUDE.md links here; nothing else restates status). Everything spec-frozen on 2026-07-10 is merged except account deletion: core loop (earn #20, Redemption #22, Ворожка #23), member code (#21), «Зміна» scanner grants + Barista Roster (#80, #97–#99), Pro gating + push campaigns (#24), analytics + free teaser (#25). Next: account deletion (#81, pre-store) → provision production (#65) → pilot & store checklist (#58)._
